...
class Profile extends StatelessWidget {
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage(
                  'asset/images/basdasj_2.png'), // Ensure this image exists in your assets folder
              fit: BoxFit.cover,
            ),
          ),
          child: Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 10),
                  Image.asset('asset/images/Naif-Logo.png',
                      height:
  ...
  void _launchWhatsApp() async {
    final Uri url = Uri.parse(
        'https://wa.me/+971544048993'); // Replace with your WhatsApp link
  ...
  void _launchContact() async {
    final Uri url =
    Uri.parse('tel:+971544048993'); // Replace with your contact number
    if (!await launchUrl(url)) {
      throw 'Could not launch $url';
    }
  }
