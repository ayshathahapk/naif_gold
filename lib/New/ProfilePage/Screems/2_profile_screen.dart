...
import 'package:naif_gold/Core/Utils/size_utils.dart';
...
class _ProfileScreen2State extends ConsumerState<ProfileScreen2> {
  ...
  void _launchMap() async {
    final Uri url = Uri.parse(
        'https://www.google.com/maps/search/?api=1&query=25.27314105066131,55.29844518995183'); // Replace with your map link
    if (!await launchUrl(url)) {
      throw 'Could not launch $url';
    }
  }
