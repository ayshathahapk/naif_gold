...
class Info {
  ...
  factory Info.fromMap(Map<String, dynamic> json) => Info(
        ...
        silverAskSpread: double.parse(json["silverAskSpread"].toString()),
        silverBidSpread: double.parse(json["silverBidSpread"].toString()),
        goldAskSpread: double.parse(json["goldAskSpread"].toString()),
        goldBidSpread: double.parse(json["goldBidSpread"].toString()),
        copperAskSpread: double.parse(json["copperAskSpread"].toString()),
        copperBidSpread: double.parse(json["copperBidSpread"].toString()),
        platinumAskSpread: double.parse(json["platinumAskSpread"].toString()),
        platinumBidSpread: double.parse(json["platinumBidSpread"].toString()),
        goldLowMargin: double.parse(json["goldLowMargin"].toString()),
        goldHighMargin: double.parse(json["goldHighMargin"].toString()),
        silverLowMargin: double.parse(json["silverLowMargin"].toString()),
        silverHighMargin: double.parse(json["silverHighMargin"].toString()),
        copperLowMargin: double.parse(json["copperLowMargin"].toString()),
        copperHighMargin: double.parse(json["copperHighMargin"].toString()),
        platinumLowMargin: double.parse(json["platinumLowMargin"].toString()),
        platinumHighMargin: double.parse(json["platinumHighMargin"].toString()),
